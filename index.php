            ...
            <div class="owl-carousel-item position-relative">
                ...
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(241, 160, 186, 0.356);">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                <h1 class="display-3 text-white animated slideInDown">Paging System</h1>
                                <p class="fs-5 text-white mb-4 pb-2">The paging system allows for quick and efficient communication between students and faculty members.</p>
    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                ...
                <a class="btn btn-link" href="FAQSandHelp.html">FAQs & Help</a>
            </div>
            <div class="col-lg-3 col-md-6">
                ...
                <div class="d-flex pt-2">
                    <a class="btn btn-outline-light btn-social" href="https://www.facebook.com/globalcity.sti.edu"><i class="fab fa-facebook-f"></i></a>
                    <a class="btn btn-outline-light btn-social" href="https://www.youtube.com/@STIdotEdu/videos"><i class="fab fa-youtube"></i></a>
                    <a class="btn btn-outline-light btn-social" href="https://twitter.com/sticollege"><i class="fab fa-twitter"></i></a>
                </div>
            </div>
