        ...
        <div class="row justify-content-center mt-5">
            <div class="col-lg-6">
                ...
                <div class="mb-3">
                    ...
                    <a href="https://www.facebook.com/globalcity.sti.edu" class="btn btn-outline-light btn-social me-2"><i class="fab fa-facebook-f"></i></a>
                    <a href="https://www.youtube.com/@STIdotEdu/videos" class="btn btn-outline-light btn-social me-2"><i class="fab fa-youtube"></i></a>
                    <a href="https://twitter.com/sticollege" class="btn btn-outline-light btn-social me-2"><i class="fab fa-twitter"></i></a>
                </div>
            </div>
        </div>
