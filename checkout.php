...
$stmt = $conn->prepare("INSERT INTO payments (user_id, FullName, address, payment_method, payment_date, total_amount, order_status) 
VALUES (?, ?, ?, ?, NOW(), ?, ?)");
$stmt->bind_param("isssds", $userId, $full_name, $address, $paymentMethod, $amount, $orderStatus);
$stmt->execute();
